...
public class ReadFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_read, container, false);//mendapat file layout
    ...
    private void loadData() {
        ...
        apiService = ApiClient.getClient().create(ApiService.class);//mendapat API
        apiService.getdataMahasiswa().enqueue(new Callback<dataMahasiswa>() {//
            @Override
            public void onResponse(Call<dataMahasiswa> call, Response<dataMahasiswa> response) {//memanggil respon
