...
public class InsertFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            apiService = ApiClient.getClient().create(ApiService.class); //pengambilan API dari api service
            Call<resultResponse> resultInsertCall = apiService.daftar(edtNIM.getText().toString(), //memanggil hasil
